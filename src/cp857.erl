...
%% FROM mappings/MICSFT/PC/CP857.TXT AT 2016-08-19
-module(cp857).
-vsn(20160819).
...
to_unicode(16#a6) -> 16#011e;
to_unicode(16#a7) -> 16#011f;
...
to_unicode(16#d0) -> 16#00ba;
to_unicode(16#d1) -> 16#00aa;
...
from_unicode(16#015e) -> 16#9e;
from_unicode(16#015f) -> 16#9f;
...
from_unicode(16#011e) -> 16#a6;
from_unicode(16#011f) -> 16#a7;
...
from_unicode(16#00ba) -> 16#d0;
from_unicode(16#00aa) -> 16#d1;
