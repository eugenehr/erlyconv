...
%% FROM mappings/MICSFT/WINDOWS/CP1257.TXT AT 2016-08-19
-module(cp1257).
-vsn(20160819).
...
to_unicode(16#8D) -> 16#00A8;
to_unicode(16#8E) -> 16#02C7;
to_unicode(16#8F) -> 16#00B8;
...
to_unicode(16#9D) -> 16#00AF;
to_unicode(16#9E) -> 16#02DB;
...
from_unicode(16#00A8) -> 16#8D;
from_unicode(16#02C7) -> 16#8E;
from_unicode(16#00B8) -> 16#8F;
...
from_unicode(16#00AF) -> 16#9D;
from_unicode(16#02DB) -> 16#9E;
