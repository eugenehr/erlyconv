...
%% FROM mappings/MICSFT/WINDOWS/CP1253.TXT AT 2016-08-19
-module(cp1253).
-vsn(20160819).
...
to_unicode(16#A1) -> 16#0385;
to_unicode(16#A2) -> 16#0386;
...
from_unicode(16#0385) -> 16#A1;
from_unicode(16#0386) -> 16#A2;
