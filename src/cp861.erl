...
%% FROM mappings/MICSFT/PC/CP861.TXT AT 2016-08-19
-module(cp861).
-vsn(20160819).
...
to_unicode(16#8b) -> 16#00d0;
to_unicode(16#8c) -> 16#00f0;
to_unicode(16#8d) -> 16#00de;
...
to_unicode(16#95) -> 16#00fe;
to_unicode(16#96) -> 16#00fb;
to_unicode(16#97) -> 16#00dd;
to_unicode(16#98) -> 16#00fd;
...
to_unicode(16#a4) -> 16#00c1;
to_unicode(16#a5) -> 16#00cd;
to_unicode(16#a6) -> 16#00d3;
to_unicode(16#a7) -> 16#00da;
...
from_unicode(16#00d0) -> 16#8b;
from_unicode(16#00f0) -> 16#8c;
from_unicode(16#00de) -> 16#8d;
...
from_unicode(16#00fe) -> 16#95;
from_unicode(16#00fb) -> 16#96;
from_unicode(16#00dd) -> 16#97;
from_unicode(16#00fd) -> 16#98;
...
from_unicode(16#00c1) -> 16#a4;
from_unicode(16#00cd) -> 16#a5;
from_unicode(16#00d3) -> 16#a6;
from_unicode(16#00da) -> 16#a7;
